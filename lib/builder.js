...
(function() {
  var ImageMagick, Layout, SpriteSheetBuilder, SpriteSheetConfiguration, Style, U, Utils, async, ensureDirectory, exec, fs, path, qfs, separator, _,
    ...
    SpriteSheetBuilder.prototype.writeStyleSheet = function(callback) {
      ...
      return fs.writeFile(this.outputStyleFilePath, css.join("\n\n"), function(err) {
        if (err) {
          ...
          U.log("CSS file written to", _this.outputStyleFilePath, "\n");
          return callback();
        }
      });
    };
  ...
  SpriteSheetConfiguration = (function() {
    ...
    SpriteSheetConfiguration.prototype.build = function(callback) {
      ...
      U.log("--------------------------------------------------------------");
      U.log("Building '" + this.name + "' at pixel ratio " + this.pixelRatio);
      U.log("--------------------------------------------------------------");
